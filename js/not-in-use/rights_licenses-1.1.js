(function () {
  ...
  function allRightsArray(){
    ...
    return fetch('/customizations/global/pages/js/rights-1.1.json')
...
1.1 - 2022 Jun 10 - add localization for 15 languages; fix for URIs in controlled vocabs (thanks to Georgia State University)
1.0 - 2022 Apr 18 - initial implementation
