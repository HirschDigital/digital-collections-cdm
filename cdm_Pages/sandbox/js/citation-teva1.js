...
async function buildMetadataObject(collAlias, itemID) {
  let response = await fetch(
    "https://cdm17480contentdm.oclc.org/iiif/info/" +
      global.collAlias +
      "/" +
      global.itemID +
      "/manifest.json"
...
function insertCitation(data) {
  ...
  var url =
    "https://cdm17480.contentdm.oclc.org/digital/collection/" +
    global.collAlias +
    "/id/" +
    global.itemID;
  ...
  const itemCite = `<hr /><strong>Citation:</strong> \n "${
    ...
    .join(
      ", "
    )}, ${url}, accessed ${dateToday}. <br>Note: This citation is auto-generated and may be incomplete. Check your preferred style guide or the <a href="https://cdm17480.contentdm.oclc.org/customizations/global/pages/about.html">About TeVA page</a> for more information.`;
