...
function puzzlepuzzle (){
    ...
    */
    ...
    { // scope for loadFile
     ...
     function loadImageList(imageList) {
        imageList.forEach(imageUrl => {
          let img = new Image();
          img.onload = function() {
            console.log(`Image loaded: ${imageUrl}`);
            puzzle.srcImage.src = img.src; // Load the image into puzzle.srcImage
          };
        ...
        // Example usage:
const imageList = [
  "/customizations/collection/myfirst/pages/images/Mona_Lisa.jpg",
  "/customizations/collection/myfirst/pages/images/lb1140_35_c74_d86_1890-014.jpg",
  "/customizations/collection/myfirst/pages/images/nk2715_g851869_0021.jpg"
];
...
loadImageList(imageList);
    ...
    let menu = (function () {
      ...
      menu.items[1].element.addEventListener("click", loadImageList);
    ...
    document.addEventListener('cdm-custom-page:ready', puzzlepuzzle);
    document.addEventListener('cdm-custom-page:update', puzzlepuzzle);
})();