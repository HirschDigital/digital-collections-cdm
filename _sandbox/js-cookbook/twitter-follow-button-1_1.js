(function () {
  ...
  function insertTwitterFollowButton(screenName){
    ...
    if (twitBtn == null || twitBtn.length === 0) {
      ...
      linkContainer.innerHTML = '<a href="https://twitter.com/' + screenName + '" class="twitter-follow-button" data-show-count="false" data-show-screen-name="true" data-size="large">Follow Hirsch</a>';
